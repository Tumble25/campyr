...
Campsite.create!(name: "Camping Maaldrift", description: "Family-friendly site near forest. Half an hour's drive from a big city. Sports facilities, swimming pool, restaurant and summer kids' club.", address: "Maaldrift 9, 2241 BN Wassenaar, The Netherlands", photo: Rails.root.join("app/assets/images/camping13.jpeg").open, price: "15", user: user2)
Campsite.create!(name: "Camping Zuidduinen", description: "Family-friendly site near forest. Half an hour's drive from a big city.", address: " Zuidduinseweg 1, 2225 JS Katwijk aan Zee, The Netherlands", photo: Rails.root.join("app/assets/images/camping10.jpeg").open, price: "16", user: user1)
...
Campsite.create!(name: "Camping Azul", description: "Peaceful wooded site on the beach", address: "CCalle Camping Azul, 1, 46780 Oliva, Valencia, Spain", photo: Rails.root.join("app/assets/images/camping12.jpeg").open, price: "17", user: user4)
