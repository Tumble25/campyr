...
Reservation.create!([user: user1, campsite: campsite2, arrival: "2019-11-24", departure: "2019-11-31", status: "Pending", total_price: 189])
Reservation.create!([user: user2, campsite: campsite5, arrival: "2019-12-24", departure: "2019-12-31", status: "Confirmed", total_price: 91])
Reservation.create!([user: user4, campsite: campsite1, arrival: "2019-11-24", departure: "2019-11-31", status: "Pending", total_price: 168])
